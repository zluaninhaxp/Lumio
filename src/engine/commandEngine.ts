...
const definitions: CommandDefinition[] = [
  { name: 'cliente', aliases: [], pluginId: 'clientes', label: 'Clientes', usage: 'Adicionar, consultar, editar ou excluir clientes', required: [], menuOnly: true },
  { name: 'fornecedor', aliases: [], pluginId: 'fornecedores', label: 'Fornecedores', usage: 'Adicionar, consultar, editar ou excluir fornecedores', required: [], menuOnly: true },
  { name: 'estoque', aliases: [], pluginId: 'estoque', label: 'Estoque', usage: 'Adicionar itens, dar entrada, dar baixa ou consultar saldo', required: [], menuOnly: true },
  { name: 'catalogo', aliases: [], pluginId: 'catalogo', label: 'Catálogo', usage: 'Adicionar produtos/serviços ou consultar o catálogo', required: [], menuOnly: true },
  { name: 'venda', aliases: ['vendas'], pluginId: 'vendas', label: 'Vendas', usage: 'Criar venda, consultar pedidos ou ver vendas da semana', required: [], menuOnly: true },
  { name: 'orcamento', aliases: ['orcamentos'], pluginId: 'orcamentos', label: 'Orçamentos', usage: 'Criar, consultar, aprovar ou recusar orçamentos', required: [], menuOnly: true },
  { name: 'entrega', aliases: ['entregas'], pluginId: 'entregas', label: 'Entregas', usage: 'Criar entrega ou consultar entregas pendentes', required: [], menuOnly: true },
  { name: 'contrato', aliases: ['contratos'], pluginId: 'contratos', label: 'Contratos', usage: 'Criar contrato ou consultar vencimentos', required: [], menuOnly: true },
  { name: 'comissao', aliases: ['comissoes'], pluginId: 'comissoes', label: 'Comissões', usage: 'Consultar ou fechar comissões', required: [], menuOnly: true },
  { name: 'agenda', aliases: [], pluginId: 'agenda', label: 'Agenda', usage: 'Agendar atendimento ou consultar horários', required: [], menuOnly: true },
  { name: 'funcionario', aliases: ['funcionarios'], pluginId: 'equipe', label: 'Equipe', usage: 'Adicionar ou consultar funcionários', required: [], menuOnly: true },

...
export default function EquipeScreen() {
  ...
  const openEdit = (employee: EmployeeItem) => { setEditingId(employee.id); setForm({ name: employee.name, role: employee.role, contact: employee.contact, commissionRate: employee.commissionRate ? String(employee.commissionRate) : '' }); setModalVisible(true); };
  const save = () => {

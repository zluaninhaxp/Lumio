...
export default function CatalogoScreen() {
  ...
  const openAdd = () => { setEditing(null); setForm(empty); setVisible(true); };
  const openEdit = (item: CatalogItem) => { setEditing(item.id); setForm({ name: item.name, kind: item.kind, unitPrice: String(item.unitPrice), unit: item.unit, controlStock: item.controlStock }); setVisible(true); };
  const save = () => {
      ...
      <View style={styles.modalOverlay}>
        <View style={styles.modalCard}>
          ...
          <View style={styles.modalActions}>
            ...
            <TouchableOpacity style={styles.modalConfirm} onPress={save}><Text style={styles.modalConfirmText}>Salvar</Text></TouchableOpacity>
          </View>
        </View>
      </View>
    </BottomSheet>
